...
file_path = "../../generate_training_data_vicuna/relations/atomic_relations_prompt"
...
try:
    with open(file_path, "r") as file:
        ...
        for row in csv_reader:
            ...
            file_path_data = "../../generate_training_data_vicuna/relations/relations_gt/" + countstr + "_undefined.csv"
                ...
                with open(file_path_data, "r") as file:
                    ...
                    for row_d in csv_reader_data:
                        with open("data/train_data.json", 'a') as f:
                            temp_dict = {}
                            temp_dict["instruction"] = formatted_prompt
